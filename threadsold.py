...
for i in daily_transactions_split:
  for trans in i:
    transactions_clean.append(trans.strip())
...
for item in range(1, len(transactions_clean),4):
  sales.append(transactions_clean[item])

for item in range(2, len(transactions_clean),4):
  thread_sold.append(transactions_clean[item])
...
# How much thread of any color was sold?
print(thread_sold)
